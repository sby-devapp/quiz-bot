...
(5, NULL, 
'What will this code output?',
    'console.log(Math.max(1, 5, 3))', '5|3|1|undefined', 'published', 'Math.max returns largest value'),
(5, NULL, 
'What will this code output?',
    'console.log(Boolean(0))', 'false|true|undefined|Error', 'published', '0 is falsy'),
(5, NULL, 
'What will this code output?',
